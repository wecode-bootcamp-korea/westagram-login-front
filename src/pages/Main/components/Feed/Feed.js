...
function Feed({
  ...
  const addCommentByClick = () => {
    ...
    setCommentsList(commentsList.concat(commentInput));
    setCommentInput("");
  };
    ...
    <article className="feed">
      ...
      <main>
        ...
        <div className="articleComments">
          <ul>
            <li>
              <a href="https://www.instagram.com/laeyoung/">{userName}</a>
      ...
      <InputContainer
        ...
        addCommentByClick={addCommentByClick}
        addCommentByEnter={addCommentByEnter}
      />
    </article>
  );
}
